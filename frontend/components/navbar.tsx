...
const landingNavItems: ReadonlyArray<{ type: "section"; sectionId: LandingSection; label: string }> = [
...
export function Navbar() {
  ...
  const handleSectionClick = (sectionId: LandingSection) => (event: MouseEvent<HTMLAnchorElement>) => {
      ...
      >
        <div className="flex h-14 items-center justify-between gap-3 px-4 sm:px-6">
          <div className="group flex shrink-0 items-center gap-2" aria-label="RelayX">
            ...
            <span className="hidden font-mono text-base font-bold tracking-tight sm:inline">RelayX</span>
          </div>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive && "border-emerald-500/25 bg-emerald-500/10 text-emerald-700 shadow-[0_0_18px_rgba(16,185,129,0.12)] dark:text-emerald-300"
                  )}
                >
                  {item.label}
                </Link>
