...
const DEFILLAMA_FIXTURE = {
  data: [
    ...
    {
      pool: 'ethereum-compound-v3-weth',
      symbol: 'WETH',
      chain: 'Ethereum',
      project: 'compound-v3',
      apy: 3.76,
    ...
    {
      pool: 'ethereum-lido-steth',
      symbol: 'STETH',
      chain: 'Ethereum',
      project: 'lido',
      apy: 2.93,
      tvlUsd: 9_500_000_000,
    },
    {
      pool: 'ethereum-morpho-usdc',
      symbol: 'USDC',
      chain: 'Ethereum',
      project: 'morpho',
      apy: 5.1,
    ...
    {
      pool: 'ethereum-compound-v3-usdc',
      symbol: 'USDC',
      chain: 'Ethereum',
      project: 'compound-v3',
      apy: 4.08,
    ...
    {
      pool: 'ethereum-compound-v3-wbtc',
      symbol: 'WBTC',
      chain: 'Ethereum',
      project: 'compound-v3',
      apy: 1.18,
